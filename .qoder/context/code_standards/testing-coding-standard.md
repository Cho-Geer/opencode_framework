...
完整约束规则见 `.qoder/context/code_standards/architecture-constraint-rules.md`（由 @Architect 维护）。以下为关键规则摘要：
...
| [系统架构设计文档](.qoder/context/requirements/系统架构设计文档（SAD）.md) | 系统架构设计 |
| [安全架构设计文档](.qoder/context/requirements/安全架构设计文档.md) | 安全测试要求 |
| [测试策略与计划](.qoder/context/requirements/测试策略与计划.md) | 测试策略总纲 |
