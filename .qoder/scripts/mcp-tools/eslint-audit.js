 ...
 * 1. Reads contract.yaml x-eslint-policy → generates .qoder/generated/tier-rules.json
...
function getStateDir() {
  ...
  return path.join(OPENCODE_ROOT, ".qoder", "state");
}
...
function generateTierRules(projectRoot) {
  ...
  const outputDir = path.join(OPENCODE_ROOT, ".qoder", "generated");
