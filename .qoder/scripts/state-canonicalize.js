 ...
 *   2. __dirname-based derivation (for scripts under .qoder/scripts/)
...
const MACHINE_JSON = path.join(OPENCODE_ROOT, ".qoder", "state", "machine.json");
  ...
  for (let i = 0; i < args.length; i++) {
    switch (args[i]) {
      ...
      case "-h":
        ...
        console.log("  --state-path    Path to machine.json (default: .qoder/state/machine.json)");
