...
- ❌ Absolutely prohibited: directly writing any business code or configuration files. Writing scheduling/status reports and tool‑inventory updates is permitted.
