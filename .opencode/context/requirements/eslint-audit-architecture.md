...
| 角色 | 职责 |
|------|------|
| @Architect | 维护 contract.yaml `x-eslint-policy`<br>维护 ESLint 插件 `.opencode/tools/eslint-plugin-booking-mock-audit/`<br>维护 MCP tool `.opencode/scripts/mcp-tools/eslint-audit.js`<br>维护 machine.json schema |
...
**位置**: `.opencode/tools/eslint-plugin-booking-mock-audit/`
...
| # | 角色 | 内容 | 产出 |
|:--:|------|------|------|
| 1 | @Architect | 创建 ESLint plugin | `.opencode/tools/eslint-plugin-booking-mock-audit/` |
