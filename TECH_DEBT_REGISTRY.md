...
- id: "TECH-001"
  ...
  status: "pending | approved | in_progress | repaid | waived"
  linked_task_id: "TXXX"
```
...
|----|------|------|--------|----------|----------|------|---------|
| TECH-001 | chart-js-token-map.md 未确认是否已同步 Sharp Design (#2ecc71) 调色板；若未同步则需更新 app-chart.component.ts | 低 | @Arbiter | 2026-05-13 | 2026-05-20 | **approved** | PHASE1-THEME-REDESIGN |
